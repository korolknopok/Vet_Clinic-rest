...
var OpenAPIClientAxios = /** @class */ (function () {
    ...
    function OpenAPIClientAxios(opts) {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, swagger_parser_1.default.dereference(this.inputDocument, this.swaggerParserOpts)];
                    case 1:
                        // to save time, just dereference input document
                    ...
                    case 3:
                        ...
                        _b = this;
                        return [4 /*yield*/, swagger_parser_1.default.dereference(cloneDeep_1.default(this.document), this.swaggerParserOpts)];
                    case 4:
                        // dereference the document into definition
        ...
        this.initSync = function () {
            ...
            dereference_1.default(parser, new options_1.default({})); // mutates this.definition (synchronous)
            // create axios instance
        ...
        this.validateDefinition = function () {
            var validateOpenAPI = new openapi_schema_validator_1.default({ version: 3 });
            var errors = validateOpenAPI.validate(_this.document).errors;
            if (errors.length) {
        ...
        this.getRequestConfigForOperation = function (operation, args) {
            ...
            var getParamType = function (paramName) {
                var param = find_1.default(operation.parameters, {
                    name: paramName,
                });
                if (param) {
                    return param.in;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, swagger_parser_1.default.parse(this.inputDocument, this.swaggerParserOpts)];
                    case 1:
                        _a.document = _b.sent();
